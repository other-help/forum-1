      ...
      <li class="media">
        ...
        <div class="media-body">
          ...
          <small class="media-body meta text-secondary">
            ...
            <span class="timeago" title="Dernière activité en :{{ $topic->updated_at }}">{{ $topic->updated_at->diffForHumans(null,true) }}</span>
          </small>
...
@else
  <div class="empty-block">Pas encore de données ~_~ </div>
@endif
